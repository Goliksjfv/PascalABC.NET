...
begin
  clrscr;
  gotoxy(x, y);     write('Сумма комплексных векторов');
  gotoxy(x, y + 1); write('Скалярное произведение комплексных векторов');
  gotoxy(x, y + 2); write('Векторное произведение комплексных векторов');
  gotoxy(x, y + 3); write('Смешанное произведение комплексных векторов');
  gotoxy(x, y + 4); write('Модуль комплексного вектора');
    ...
    case n of     
      ...
      4:
        begin
          ...
          writeln('Смешанное произведение комплексных векторов a и b:');
          gotoXY(7, 8);
          Output(p);
          PressAnyKey;
        end;
