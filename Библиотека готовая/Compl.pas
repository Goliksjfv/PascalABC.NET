...
begin
  clrscr;
  gotoxy(x, y);     write('Сложение комплексных чисел');
  gotoxy(x, y + 1); write('Умножение комплексных чисел');
  gotoxy(x, y + 2); write('Инверсия комплексного числа');
  gotoxy(x, y + 3); write('Деление комплексных чисел');
  gotoxy(x, y + 4); write('Умножение комплексного числа на скаляр');
  gotoxy(x, y + 5); write('Модуль комплексного числа');
